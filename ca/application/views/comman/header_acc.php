...
<header id="navbar">
  <div id="navbar-container" class="boxed">
    <div class="navbar-header"> <a href="#" class="navbar-brand" style=" background-color: #101d25;"> <img src="<?=base_url('assets/')?>web/img/logos/kt-logo-02.png" alt="Logo" class="brand-icon" style="width:100%; height: 40px;margin-top: 10px; padding: 5px;"> </a> </div>
            ...
            <div class="profile-wrap text-center">
              <div class="pad-btm">
                ...
                <p class="mnp-name" style="margin-top: 15px;">
						...
						<?php $record	=	$this->comman_fun->get_table_data('membermaster',array('usercode'=>$this->session->userdata['pbm_accountant']['usercode']));
