        ...
        <li id="dropdown-user" class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right"> <span class="ic-user pull-right"> <i class="demo-pli-male"></i> </span> </a>
          <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
            <ul class="head-list">
			  ...
			  <li> <a href="<?=file_path('client')?>profile/change_password"><i class="demo-pli-unlock icon-lg icon-fw"></i> Change Password</a> </li>
      ...
      <div class="nano">
        <div class="nano-content">
              ...
              <div class="pad-btm">
                ...
                <img class="img-circle img-md" src="<?=base_url('assets/')?>images/profile.png" alt="Profile Picture">
					  ...
					  <p class="mnp-name" style="margin-top: 15px;">
						...
						<?php $record	=	$this->comman_fun->get_table_data('membermaster',array('usercode'=>$this->session->userdata['pbm_client']['usercode']));
          ...
          <ul id="mainnav-menu" class="list-group">
			...
			<li> <a id="menu-user" href="<?=file_path('client')?>user/view"> <i class="demo-pli-male icon-lg icon-fw"></i> <span class="menu-title">User</span> </a> </li> 
			  
           	<!-- <li> <a id="menu-document_master" href="<?=file_path('client')?>upload_document/view"><i class="demo-pli-file-html"></i><span class="menu-title">Upload Document</span></a></li> -->
			  
			<li> <a id="menu-itr" href="<?=file_path('client')?>itr_document/view"><i class="demo-pli-file-html"></i><span class="menu-title">ITR Document</span></a></li>
			  
			<li> <a id="menu-gst" href="<?=file_path('client')?>gst_document/view"><i class="demo-pli-file-html"></i><span class="menu-title">GST Document</span></a></li>  
			  
			<!-- <li> <a id="menu-od" href="<?=file_path('client')?>other_document/view"><i class="demo-pli-file-html"></i><span class="menu-title">Other Document</span></a></li> -->   
			  
			<li> <a id="menu-myin" href="<?=file_path('client')?>my_invoices/view"><i class="demo-pli-file-html"></i><span class="menu-title">MY Invoices</span></a></li>    
           
			<li> <a id="menu-myin" href="<?=file_path('client')?>payment_reciept/view"><i class="demo-pli-file-html"></i><span class="menu-title">MY Payment Reciept</span></a></li>  
			  
			<li> <a id="menu-support" href="<?=file_path('client')?>support/view"> <i class="demo-pli-mail"></i> <span class="menu-title"> Support </span> </a> </li>
              
            <!-- <li> <a id="menu-service_request" href="<?=file_path('client')?>service_request/view"> <i class="demo-pli-pen-5"></i> <span class="menu-title">Request Service</span> </a> </li> -->
