    ...
    <div class="panel-body">
		    ...
		    <div class="form-group">
              ...
              <div class="col-sm-9">
                ...
                <textarea class="form-control" id="noti_desc" name="noti_desc" required="required" placeholder="Message"><?=$form_value?></textarea>

                <?php echo form_error('noti_desc', '<p class="error_p">', '</p>'); ?> </div>
