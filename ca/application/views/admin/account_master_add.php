       ...
       <form action="<?=file_path('admin')?><?=$this->uri->rsegment(1)?>/insert" method="post" class="form-horizontal row-border" enctype="multipart/form-data" autocomplete="off">
		    ...
		    <div class="form-group">
              ...
              <div class="col-sm-9">
                ...
                <textarea class="form-control" id="address" name="address"  placeholder="Address"><?=$form_value?></textarea>
		    ...
		    <div class="form-group">
              ...
              <div class="col-sm-9">
                ...
                <input type="text" class="form-control" id="city" name="city" value="<?=$form_value?>" placeholder="City">
