...
$(document).ready(function(e) {
	...
	var table_header = '<div class="tb1" style="height:400px;" ><table class="table"><thead id="hd"  ><tr id="head_tr" >'+$('#head_tr').html()+'</tr></thead><tbody id="item_tr1" class="item_tr1" style="font-size:12px!important;">'; 
	var table_header2 ='<div class="tb1" style="height:400px;"><table class="table"><thead id="hd"  ><tr id="head_tr" style="border-top:2px solid black;">'+$('#head_tr').html()+'</tr></thead><tbody id="item_tr1" class="item_tr1" style="font-size:12px!important;">'; 
	...
	for(var i=1 ; i<=page;i++){
		...
		page_dt+='<div style="clear:both;overflow:hidden;"><section class="pull-left"><span class="footer_text_left"> This is computer generated reciept.</span></section><section class="pull-right" style="margin-right:10px">Page '+i+' Of '+page+'</section></div> ';
		page_dt+=end_html;
...
<section class="main_body" id="main_body">
 ...
 <section class="nomargin page_section" >
      ...
      <span class="order" >Payment Receipt </span> </section>
		<!------/ Page heading ----->
...
Gujarat, India
  ...
  <section class="pull-right buyer_section" style="margin-bottom:0px !important;height:208px;"> 
   <table border="0" class="" style="margin-top: 10px;margin-bottom: 62px;margin-left: 5px;">
      <tbody>
        ...
        <tr>
          <td  width="128px">Reciept No. </td>
            <td width="10px">: </td>
		
			 <td><?=$invoice = sprintf("%04d", $invoice_master[0]['id'])?></td>
        ...
        <tr>
          ...
          <td><?=date('d/m/Y',strtotime($invoice_master[0]['date_info'])); ?></td>
        </tr>
		...
		<tr>
          <td  width="128px">Invoice No. </td>
            <td width="10px">: </td>
			 ...
			 <td><?=$invoice = sprintf("%04d", $invoice_master[0]['invoice_no'])?></td>
        <?php /*?>  <td><?=$invoice_master[0]['invoice_id']?></td><?php */?>
        </tr>
        ...
        <tr>
          ...
          <td><?=date('d/m/Y',strtotime($invoice_date[0]['invoice_date'])); ?></td>
        </tr>  
  ...
  <!-- Item  table -->
 	  ...
 	  <div class="tb1" id="itemtable" style="height:400px !important;">
      <table class="table" >
        <thead  id="hd">
          <tr id="head_tr">
    ...
    <tbody id="item_tr1" class="item_tr1" style="font-size:12px!important;">
		...
		<tr id="item_tr" class="item_tr">
            ...
            <td style="word-wrap:break-word;border-right:2px solid black; text-align: left !important;padding-left: 5px !important;">Payment Received. </td>
            <td style="border-right:2px solid black;text-align:left; padding-left: 5px !important;"><?=$invoice_master[0]['amount']?> /-</td>
        
      </tr>
      
     	<tr class="item_tr">
            
          <td colspan="2" style="border-left: 2px solid black !important;border-right: 2px solid black !important;font-weight: bold;font-size: 15px;text-align: right;padding-right: 5px !important;">Discount</td>
          <td style="padding-left: 5px !important;border-right:2px solid black; text-align: left;"><?=$invoice_master[0]['discount_amount']?> /-</td>		
     </tr>
       ...
       <tr class="item_tr">
          ...
          <td style="padding-left: 5px !important;border-right:2px solid black; text-align: left;"><?=$invoice_master[0]['tot_amt']?> /-</td>		
     </tr>
