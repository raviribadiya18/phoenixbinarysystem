...
?>
					...
					<option <?=$sel3?> value="3B">3B</option>
		   ...
		   <div class="form-group">
              ...
              <label class="col-sm-2 control-label">ROC Title</label>

              <div class="col-sm-9">

                <?php $form_value = set_value('title', isset($result[0]['title']) ? $result[0]['title'] : '');?>
                <input type="text" class="form-control" id="title" name="title" required="required" placeholder="ROC Title" value="<?=$form_value?>">
		    ...
		    <div class="form-group">
              ...
              <label class="col-sm-2 control-label">Upload your ROC file here</label>
