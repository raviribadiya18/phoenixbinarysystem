	...
	?>
			 ...
			 <div class="form-group">
              ...
              <div class="col-sm-9">
                ...
                <?php $form_value = set_value('type', isset($result[0]['type']) ? $result[0]['type'] : '');?>


                <select class="form-control" name="type" id="type" data-placeholder="Select type Here" required>
					<?php
if ($result[0]['type'] == "6 Month") {
	$sel1 = "selected=selected";
} else {
	$sel1 = "";
}

if ($result[0]['type'] == "1 Year") {
...
?>
					...
					<option <?=$sel1?> value="6 Month">6 Month</option>
					<option <?=$sel2?> value="1 Year">1 Year</option>

				</select>

                <?php echo form_error('type', '<p class="error_p">', '</p>'); ?> </div>
		   ...
		   <div class="form-group">
              ...
              <label class="col-sm-2 control-label">ITR Title</label>

              <div class="col-sm-9">

                <?php $form_value = set_value('title', isset($result[0]['title']) ? $result[0]['title'] : '');?>
                <input type="text" class="form-control" id="title" name="title" required="required" placeholder="ITR Title" value="<?=$form_value?>">
		    ...
		    <div class="form-group">
              ...
              <label class="col-sm-2 control-label">Upload your ITR file here</label>
