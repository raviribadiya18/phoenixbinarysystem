<?php
Class Upload_document_module extends CI_Model
{
	...
	function get_document()
 	{	
		...
		$this -> db -> where('document_master.usercode', $this->session->userdata['pbm_client']['usercode']);
