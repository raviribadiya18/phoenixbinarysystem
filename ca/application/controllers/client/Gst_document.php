...
class Gst_document extends CI_Controller {
	...
	function __construct()
 	{
		...
		if(!is_login('client')){
   		...
   		$this->load->model('client/Gst_document_module','ObjM',TRUE);
...
//					
//					$file	=	"<a style='color:red;' href='".base_url()."upload/web/gst/".$result[$i]['upload_file']."' download>Download GST file Here</a>";
//					
//				}else{
//					
//					$file	=	"-";
//				}
					...
					if($result[$i]['is_paid']=="yes"){
							...
							if($result[$i]['upload_file']!=""){
								...
								$file	=	"<a href='".base_url()."upload/web/gst/".$result[$i]['upload_file']."' download><span style='color:red;font-size:15px;'>Download File Here.</span></a>";
